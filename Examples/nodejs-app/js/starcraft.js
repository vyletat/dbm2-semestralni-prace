...
console.log(alasql('SELECT * FROM ? ORDER BY rating DESC', [ladder230898_1031.team]));
...
console.log(alasql('SELECT COUNT(*) FROM ? WHERE last_played_time_stamp > 1604079724', [ladder230898_1031.team]));
